...
func help() {
  ...
  fmt.Println("  nvm node_mirror [url]        : Set the node mirror. Defaults to https://nodejs.org/dist/. Leave [url] blank to see the current mirror.")
  fmt.Println("                                 Set [url] to \"none\" to remove the mirror.")
  fmt.Println("  nvm npm_mirror [url]         : Set the npm mirror. Defaults to https://github.com/npm/npm/archive/. Leave [url] blank to see the current mirror.")
  fmt.Println("                                 Set [url] to \"none\" to remove the mirror.")
